...
```{r include=FALSE}
library(stringr); library(purrr); library(magrittr); library(lubridate); library(codetools); library(readr); library(dplyr)
```
...
**範例5.3.13**：管家機器人  
* 早上 (06:00-09:00)：  
    + 媽媽讀《經濟學人》(<https://economist.com>[link](economist.com))。  
    + 爸爸讀《WSJ》(<https://www.wsj.com/>[link](www.wsj.com))。  
    + 提醒小明"檢查書包東西都有帶嗎？"。  
* 傍晚 (17:00-19:00)：  
    + 媽媽準備全家晚餐點 foodpanda (<https://www.foodpanda.com.tw/>[link](www.foodpanda.com.tw))。  
    + 爸爸瀏覽 tripadvisor (<https://www.tripadvisor.com/>[link](www.tripadvisor.com))規劃週末全家旅行。  
    + 提醒小明"作業寫好了嗎？"。  

* 晚上 (23:30-次日淩晨1點)：
    + 媽媽聆聽Spotify Jazz Classics (<https://open.spotify.com/playlist/37i9dQZF1DXbITWG1ZJKYt>[link](open.spotify.com/playlist/37i9dQZF1DXbITWG1ZJKYt))。  
